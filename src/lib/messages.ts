...
export const SAFEINSERT_OPEN_SIDE_PANEL_REQUEST = 'SAFEINSERT_OPEN_SIDE_PANEL_REQUEST';
export const SAFEINSERT_SIDE_PANEL_ACTIVATED = 'SAFEINSERT_SIDE_PANEL_ACTIVATED';
...
export type SafeInsertRuntimeMessage =
  ...
  | { type: typeof SAFEINSERT_OPEN_SIDE_PANEL_REQUEST }
  | { type: typeof SAFEINSERT_SIDE_PANEL_ACTIVATED }
